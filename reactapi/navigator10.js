  ...
  <ScrollView>
    ...
    {navigation.state.routeName === 'HeaderTest' && <Button
      ...
      onPress={() => navigation.setParams({
        headerVisible: (!navigation.state.params || !navigation.state.params.headerVisible),//当navigation.state.params存在的时候，看navigation.state.params.headerVisible，
      })}
    />}
    <Button
...
MyHeaderTestScreen.navigationOptions = ({ navigation }) => {
  ...
  return {
    header: headerVisible ? undefined : null,//header设置为null就会隐藏标题。
